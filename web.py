...
from ucca.convert import passage2file, to_standard
...
state_path = os.path.join(save_path, "parser.pt")
...
def test(sentence, draw=True):
    ...
    ucca_file = prediction(test_loader)
    #convert_xml(ucca_file[0]), 
    return visualize(ucca_file, False)
...
# print(test("Bu bir denemedir", True))
