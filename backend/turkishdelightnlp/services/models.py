...
from turkishdelightnlp.core.config import DATA_PATH
from turkishdelightnlp.models.joint.runtime import load_model as joint_lm
from turkishdelightnlp.models.joint.runtime import (predict_dependecy,
                                                    predict_joint,
...
class JointModel(BaseModel):
    ...
    def load_local_model(self):
        model_path = os.path.join(DATA_PATH, self.model_info["model_path"])
        model_opts_path =  os.path.join(DATA_PATH, self.model_info["model_opts_path"])
